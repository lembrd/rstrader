...
pub enum AppError {
    ...
    Exchange { #[from] source: ExchangeError },
    ...
    Parquet { #[from] source: parquet::errors::ParquetError },
    
    #[error("Arrow error: {source}")]
    Arrow { #[from] source: arrow::error::ArrowError },
...
impl AppError {
    ...
    pub fn connection(message: impl Into<String>) -> Self {
        Self::Exchange { 
            source: ExchangeError::Connection { message: message.into() } 
        }
    }
    
    pub fn validation(message: impl Into<String>) -> Self {
        Self::Exchange { 
            source: ExchangeError::Symbol { message: message.into() } 
        }
    }
    
    pub fn data(message: impl Into<String>) -> Self {
        Self::Exchange { 
            source: ExchangeError::Parse { message: message.into() } 
        }
    }
    
    pub fn stream(message: impl Into<String>) -> Self {
        Self::Exchange { 
            source: ExchangeError::Protocol { message: message.into() } 
        }
    }
